...
@Autonomous(name="Auto power shot", group="Auto")
public class FTC_14133_2021_Auto_Power_Shot extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Rotate(7.5,0.5);  // turn towards power shot

        ConveyorFunction(0.5);  //shoot rings in conveyor

        sleep(1000); //time to shoot rings in conveyor
        ...
        if (count == 0) {       // if zero rings are picked up, do this portion of code
            ...
            ForwardorBackwards(-52,0.7);

            Rotate(90,0.5);

            ForwardorBackwards(8, 0.4);
